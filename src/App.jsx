        ...
        <main className="pt-16">
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
            ...
            <div className="flex justify-center flex-col-reverse md:flex-row gap-4">
              <button className="inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
          ...
          <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <Link
                  to="#"
                  className="flex mt-2 md:hidden items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-purple-600 hover:bg-purple-700"
                >
                  View all posts
                </Link>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Overview</Link></li>
                    ...
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Tutorials</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Pricing</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Releases</Link></li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">News</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Media kit</Link></li>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Newsletter</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Events</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Help centre</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Tutorials</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Support</Link></li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Startups</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Enterprise</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Government</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">SaaS centre</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Marketplaces</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Ecommerce</Link></li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Twitter</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">LinkedIn</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Facebook</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">GitHub</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">AngelList</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Dribble</Link></li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Licenses</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Settings</Link></li>
                    <li><Link to="#" className="text-sm text-gray-600 hover:text-gray-900">Contact</Link></li>
                  </ul>
                </div>
              </div>
